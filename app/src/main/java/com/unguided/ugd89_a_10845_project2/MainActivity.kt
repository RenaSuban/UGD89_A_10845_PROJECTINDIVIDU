package com.unguided.ugd89_a_10845_project2
...
import com.unguided.ugd89_a_10845_project2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun createNotificationChannel(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            val name = "UGD89_A_10845_PROJECT2"
    ...
    private fun sendNotification2(){
        val builder = NotificationCompat.Builder(this, CHANNEL_ID_2)
            ...
            .setContentTitle("MODUL89_A_10845_PROJECT2")
